...
Folder zawiera lokalne assety używane przez `next/image`.

Obecnie dostępne są obrazy:

- `hero-pv-bess.png` - główny obraz hero PV + BESS
- `solar-landscape.png` - krajobraz fotowoltaiczny
...
Strona używa wyłącznie lokalnych plików z tego folderu przez `next/image`.
